...
public class VectorConstantRange extends ConstantRange {
    // Dimension of input vectors are 128
	private static VectorConstant NEG_INF = new VectorConstant(128, -9999) {
		@Override
	...
	private static VectorConstant INF = new VectorConstant(128, 9999) {
		@Override
		public boolean equals(Object obj) {
			if (obj == this)
				return true;
			if (obj == null || !(obj instanceof VectorConstant))
				return false;
			// no other vector constants are equal to INF
			return false;
		}
	 ...
	 */
	public VectorConstantRange(float[] low, boolean lowIncl, float[] high,
			boolean highIncl) {
		if (low == null)
			this.low = NEG_INF;
		else {
