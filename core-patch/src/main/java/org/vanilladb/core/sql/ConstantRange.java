...
public abstract class ConstantRange {
	...
	public static ConstantRange newInstance(Constant low, boolean lowIncl,
		...
		// TODO Final
			...
			VectorConstant lowVarchar = low != null ? (VectorConstant) low
					: null;
			VectorConstant highVarchar = high != null ? (VectorConstant) high
					: null;
			return new VectorConstantRange(lowVarchar, lowIncl,
					(VectorConstant) highVarchar, highIncl);
		}
